...
export const metadata: Metadata = {
  ...
  description:
    'Дополнительные услуги LariBrand в Саратове: ботокс на кончики, экспресс-уход, пилинг головы, полировка волос, укладка Dyson, хелатное мытьё, чистка полотна, экспресс-смывка. Цены от 700 ₽.',
  keywords: [
  ...
  openGraph: {
    title: 'Дополнительные услуги для волос в Саратове — LariBrand',
    description: 'Ботокс на кончики, экспресс-уход, пилинг, полировка, хелатное мытьё в Саратове. Цены от 700 ₽.',
  ...
  return (
    <>
      <ServiceSchema
        ...
        description="Дополнительные процедуры по уходу за волосами: ботокс на кончики, экспресс-уход, пилинг, полировка, укладка Dyson, хелатное мытьё, чистка полотна и экспресс-смывка."
        url="https://laribrand.ru/additional_services"
        priceFrom="700"
      />
      <Header />
