const LocalBusinessStructuredData: React.FC = () => {
  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'BeautySalon',
    name: 'LariBrand - Дома эстетики волос',
    description:
      'Салон красоты премиум-класса в Саратове. Кератиновое выпрямление, ботокс для волос, парикмахерские услуги, окрашивание, стрижки.',
